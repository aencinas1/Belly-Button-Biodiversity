...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var sampleArray = samples.filter(sampleObj => sampleObj.id == sample.id);
    ...
    console.log(otuids);
    var otulabels = sampleResult.otu_labels.slice(0, 10).reverse();
    ...
    Plotly.bewPlot("bar", barData, barLayout);
  });
}
